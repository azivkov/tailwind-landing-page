    ...
    <>
      <nav className="flex justify-between items-center">
        <div className="flex">
          ...
          <button className="hidden md:block header-btn">about us</button>
        </div>
        <div className="flex">
          <button className="hidden md:flex header-btn mr-3 items-center">
          ...
          <button className="hidden md:flex header-btn items-center">
      ...
      {menu && (
        <div className="md:hidden bg-extraGray py-5 px-7 rounded-3xl mt-5 text-xl font-semibold text-right leading-10">
          <div>about us</div>
          <div>pricing</div>
          <div>faq</div>
          <div>log in</div>
