  ...
  return (
    <div className="flex py-7">
            ...
            <div className="mt-5 flex items-center">
              ...
              <div>
                <svg
                  ...
                  stroke-width="1.5"
                  stroke="currentColor"
                  class="w-16 h-16 bg-gray-400 text-gray-950 rounded-full p-5 cursor-pointer hover:bg-gray-950 hover:text-gray-400 transition ease-in-out duration-300"
                >
                  <path
      ...
      <div className="w-5/12">
        <div className="bg-gold bg-cover max-w-full h-full rounded-3xl flex justify-center items-end">
